...
\begin{titlepage}
    ...
    \center
    {\includegraphics[scale=0.5]{../../logo0.png}\hfill{\Large\bfseries \shortstack{Michaelmas 2019  \\ -- Epiphany 2020}}}\\[2.5cm]
...
Any Quantum Field Theory which constrains quantum corrections such as a tree level interaction, then one loop correction and up to higher loops, e.g.
\begin{equation}
    ...
    \item What if we consider $m^2\to-m^2$?
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \draw[-Latex] (-1.5,0) -- (1.5,0);
                \draw[-Latex] (0,-0.5) -- (0,2);
                \draw (-1.5,2) sin (-0.75,-0.5) cos (-0.375,-0.25) sin (0,0) cos (0.375,-0.25) sin (0.75,-0.5) cos (1.5,2);
                \fill (0,0) circle (2pt);
