...
\end{align}
\end{multicols}
Consider simple cavity, \textit{doodle one from previous diagrams, with I+ going out, I- going back}.
...
\textit{Look again at usual two level diagram, with s1, s2, n2/tau2, n1/tau1, n2a21 in between}
\begin{align}
    \frac{dN_2}{dt} &= S_2 - \frac{N_2}{\tau_2} \\
    \frac{dN_1}{dt} &= S_1 + N_2A_{21} - \frac{N_1}{\tau_1} 
\end{align}
...
\textit{doodle three level transition, laser transition from 2 to 1, pump from 1 to 3, fast decay from 3 to 2.}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (2,0);
        ...
        \draw[-Latex] (1.3,2) -- (1.3,1.3);
        \draw[-Latex] (1.7,1.3) -- (1.7,0);
    \end{tikzpicture}
\end{figure}
This is known as the traditional solid state three-level laser, e.g. Ruby. \\
\textit{doodle three level transition, laser trans from 2 to 1, fast decay from 1 to 0, pump from 0 to 3.}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (2,0);
...
\textit{doodle four three level transition, laser from 2 to 1, fasy decay from 3 to 2 and 1 to 0, pump from 0 to 3.}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (2,0);
        ...
        \draw (0,2) -- (2,2);
        \draw[-Latex] (0.5,0) -- (0.5,2);
        \draw[-Latex] (1.3,2) -- (1.3,1.4);
        \draw[-Latex] (1.7,1.4) -- (1.7,0.7);
        \draw[-Latex] (1.3,0.7) -- (1.3,0);
    \end{tikzpicture}
\end{figure}
...
\textit{doodle the traditional laser again, but bigger, label pumping as S13 with rate s-1, add decay right back down again gamma31, we want gamma32, and laser transition gamma21}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (2,0);
        \draw (1,1.3) -- (2,1.3);
        \draw (0,2) -- (2,2);
        \draw[-Latex] (0.3,0) -- (0.3,2);
        \draw[-Latex] (1.3,2) -- (1.3,1.3);
        \draw[-Latex,red] (1.7,1.3) -- (1.7,0);
        \draw[-Latex] (0.6,2) -- (0.6,0);
        \draw[-Latex] (1.2,1.3) -- (1.2,0);
    \end{tikzpicture}
\end{figure}
...
\textit{finish the doodle, lots of circles in 0, some in 2, arc arrow between them}
\begin{figure}[H]
    \centering
    \begin{tikzpicture}
        \draw (0,0) -- (3,0) node[anchor=west] {0};
