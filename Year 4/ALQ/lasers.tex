...
\chapter{}
\textit{dotted cylinder again, one meter long.}
...
\textit{doodle of cavity, mirrors either side of gain medium, arrows diverting round.}

\section{General Cavity Design}
\textit{doodle parallelogram gain medium ($\eta_mi,L_m$), curved mirrors either side, cavity with $\eta_c$, length of caivty $L_c$, and intracavity element induces a loss $a$. Mirror 1 (left) reflectivity as close to 1 as we can get. Mirror 2 is output coupler, must be less than 1 so laser can eventually escape. Label of $\alpha$ near mirror 2.} \\
